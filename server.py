...
# ---------------------------------------------------------------------
MODEL_PATH = os.getenv("QUICKDRAW_MODEL_PATH", "quickdraw_saved_model")  # ✅ SavedModel format
...
if not os.path.exists(MODEL_PATH):
    logger.error("❌ Model folder not found at %s", MODEL_PATH)
...
if __name__ == "__main__":
    port = int(os.getenv("PORT", 8080))  # ✅ Deta Space expects 8080
